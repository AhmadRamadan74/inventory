      ...
      <div className="animate-fade-in" style={{ width: '100%', maxWidth: 420, position: 'relative' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          <div style={{
            ...
            <SaudLogo size={52} color="#C9A84C" />
          </div>
          <h1 style={{ color: 'var(--text-primary)', fontSize: 28, fontWeight: 800, margin: 0 }}>
            سعود العقارية
          </h1>
          <p style={{ color: '#C9A84C', fontSize: 13, marginTop: 4, fontWeight: 600 }}>
            SAUD REAL ESTATE
          </p>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} dir="rtl" style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            {/* Full Name */}
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input
                  ...
                  style={{ paddingLeft: 40, textAlign: 'right' }}
                />
              </div>
            </div>
          ...
          <div style={{ marginTop: 20, textAlign: 'center' }}>
            <p style={{ color: 'var(--text-muted)', fontSize: 13 }}>
              لديك حساب؟{' '}
              <Link to="/login" style={{ color: '#C9A84C', fontWeight: 700, textDecoration: 'none' }}>
                تسجيل الدخول
              </Link>
            </p>
          </div>
